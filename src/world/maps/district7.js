// District 7 — the original arena: a wide urban block with long sightlines, a
// central plaza and five connected districts.
import * as THREE from 'three';
import { MapBuilder, truck, car, crateStack } from '../builder.js';
...
export function build(scene, physics) {
  ...
  meshes.push(sandMesh);   // tracked so a map switch can remove it
  physics.build();
